...
```{r getData}
#imports data
cdc = read.csv("C:/Users/Ecava/OneDrive/Desktop/Version Control/SVI2020_US.csv", header = TRUE)
...
zips = read.csv("C:/Users/Ecava/OneDrive/Desktop/Version Control/ZIP_TRACT_122020.csv", header = TRUE)
...
```{r writeData}
write.csv(cdcUnik, "C:\\Users\\Ecava\\OneDrive\\Desktop\\Version Control\\cdcUnik.csv", row.names=FALSE)
write.csv(cdcFAtract, "C:\\Users\\Ecava\\OneDrive\\Desktop\\Version Control\\cdcFAtract.csv", row.names=FALSE)
```
