...
dataa <- withStrata[,c()] #remove cols with high correlation and run again
...
reduced <- subset(withStrata,select = -c(E_TOTPOP,EP_UNEMP, EP_UNINSUR,	EP_AGE65,	EP_AGE17,	EP_DISABL,EP_SNGPNT, EP_MUNIT,	EP_MOBILE,EP_CROWD,	EP_GROUPQ))


Histo_By_Strat(withStrata, "STATE", "RPL_THEMES", "STATE_PA1")
```
