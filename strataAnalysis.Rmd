...
```{r getData}
cdcUnik <- read.csv("C:/Users/Ecava/OneDrive/Desktop/Version Control/cdcUnik.csv", header = TRUE)
cdcFAtract <- read.csv("C:/Users/Ecava/OneDrive/Desktop/Version Control/cdcFAtract.csv", header = TRUE)
```
...
```{r uniqueness}
#idk why this isnt working, is the picture too small???
